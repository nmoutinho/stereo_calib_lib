#ifndef _SPHERICAL_STEREO_CALIB_LIB_H_
#define _SPHERICAL_STEREO_CALIB_LIB_H_
...
struct spherical_stereo_calib_params
{
    double baseline;
...
struct spherical_stereo_calib_data
{
...
struct spherical_stereo_disparity_data
{
...
class spherical_stereo_calib {

    public:

        spherical_stereo_calib_params sscp_general;
        ...
        calibrationSphericalStereoCameras csc;
	...
	public:
		...
		spherical_stereo_calib(spherical_stereo_calib_params sscp_general_);
		...
		spherical_stereo_calib_data get_calibrated_transformations();
        spherical_stereo_disparity_data get_disparity_map(cv::Mat left_image, cv::Mat right_image);
