#ifndef _CALIBRATION_SPHERICAL_MULTIPLE_FILTER_STEREO_CAMERAS_H_
#define _CALIBRATION_SPHERICAL_MULTIPLE_FILTER_STEREO_CAMERAS_H_
...
struct calibrationSphericalMultipleFilterStereoCameras_data
{
...
class calibrationSphericalMultipleFilterStereoCameras: public EKF {
	...
	public:
        ...
        // 0: ty / 1: tz / 2: rx / 3: ry / 4: rz
        int id_variable_to_estimate;
